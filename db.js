...
db.serialize(() => {
  ...
  // Tabla 4: CURSOS (depende de profesores y materias)
  db.run(`
  ...
  // Tabla 5: INSCRIPCIONES (depende de estudiantes y cursos)
  db.run(`
  ...
  // Tabla 6: NOTAS (depende de inscripciones)
  db.run(`
  ...
  // Tabla 7: HORARIOS (depende de cursos)
  db.run(`
